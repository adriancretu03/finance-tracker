...
@pytest.mark.django_db
def test_cannot_add_transaction_with_amount_negative(
    user,
    transaction_dict_params,
    client,
):
...
def test_update_transaction_request(user, transaction_dict_params, client):
    ...
    # update the transaction via POST request
    transaction_dict_params["amount"] = 500
...
def test_delete_transaction_request(user, transaction_dict_params, client):
    ...
    # check the transaction has been DELETED
